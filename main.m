...
file_list = dir(fullfile(data_directory, '**', '*_filtered_segment_*.mat')); % List all filtered segment .mat files in subdirectories
...
for file_idx = 1:numel(file_list)
    ...
    emg_filtered = emg_data.emg_segment;
...
for file_idx = 1:numel(file_list)
    ...
    eeg_filtered = eeg_data.eeg_segment;
