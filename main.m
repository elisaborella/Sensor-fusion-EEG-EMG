...
eeg_data = load("Data\filtered_EEG_data\S1_R1_G1\S23_R1_G1.mat");

emg_data = load("Data\filtered_EMG_data\S1_R1_G1\S23_R1_G1.mat");
...
extract_cmc_feat('Data\filtered_EMG_data\', 'filtered_EEG_data\', 'Data\CMC_features');