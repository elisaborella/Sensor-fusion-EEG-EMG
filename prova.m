...
%             emg_filename = fullfile(subject_directory, sprintf('S%d_%s_%s.mat', s, repetitions{r}, gestures{g}));
% 
...
%                 dataset = emg_data.data; % Assuming 'data' contains the EMG data
% 
...
%                 save_filename = fullfile('path/to/save/features', sprintf('%s_%s_%s_features.mat', subjects{s}, repetitions{r}, gestures{g}));
